...
public class UserTests {
	...
	public void testGetUser()
	{
		...
		Response response = UserEndPoints.readUser(this.userpayload.getUsername()); // this to refer payload
		response.then().log().all();
		//response.statusCode();
...
@Test(priority = 3)
	...
	userpayload.setPassword(faker.internet().safeEmailAddress());
		...
		Response responseAfterUpdate = UserEndPoints.readUser(this.userpayload.getUsername()); // this to refer payload
